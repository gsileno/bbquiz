...
* ESS questions consist of a line with a text with the request, and an empty following line (you need yet an additional empty line to separate this and the next quiz).
